<?php /* Smarty version 3.1.27, created on 2019-11-29 14:06:51
         compiled from "/home/vagrant/code/admin/web/admin/template/adDataIOS/userEffect.tpl" */ ?>
<?php
/*%%SmartyHeaderCode:17055194135de0b57b31a317_49014192%%*/
if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'bc7fc7fae98d95bf41c9da277fb8e96ff9b683a8' => 
    array (
      0 => '/home/vagrant/code/admin/web/admin/template/adDataIOS/userEffect.tpl',
      1 => 1558417906,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '17055194135de0b57b31a317_49014192',
  'variables' => 
  array (
    'widgets' => 0,
    '_user_list' => 0,
  ...
  'version' => '3.1.27',
  'unifunc' => 'content_5de0b57b37dbd9_45479991',
),false);
/*/%%SmartyHeaderCode%%*/
if ($_valid && !is_callable('content_5de0b57b37dbd9_45479991')) {
function content_5de0b57b37dbd9_45479991 ($_smarty_tpl) {

$_smarty_tpl->properties['nocache_hash'] = '17055194135de0b57b31a317_49014192';
...
>
    $(function(){
        ...
        $('#printExcel').click(function(){
            ...
            location.href='?ct=adDataIOS&ac=userEffectExcel&parent_id='+$('select[name=parent_id]').val()+'&game_id='+$('select[name=game_id]').val()+'&user_id='+$('select[name=user_id]').val()+'&rsdate='+$('input[name=rsdate]').val()+'&redate='+$('input[name=redate]').val()+'&psdate='+$('input[name=psdate]').val()+'&pedate='+$('input[name=pedate]').val();
        });
