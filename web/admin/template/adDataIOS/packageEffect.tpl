...
<div id="areascontent">
    <div class="rows" style="margin-bottom: 0.8%; overflow: hidden;">
        ...
        <form method="get" action="" class="form-inline">
            ...
            <input type="hidden" name="ac" value="packageEffect" />
                ...
                <table class="table table-bordered table-bordered">
                    ...
                    <{foreach from=$data.list key=key item=item}>
                        <tr>
                            ...
                            <!--<td class="text-danger" data-sort-value="<{$item.old_money}>"><b>¥<{$item.old_money}></b></td>-->
...
<script>
    $(function(){
        ...
        location.href='?ct=adDataIOS&ac=packageEffectExcel&game_id='+$('select[name=game_id]').val()+channel_ids+'rsdate='+$('input[name=rsdate]').val()+'&redate='+$('input[name=redate]').val()+'&psdate='+$('input[name=psdate]').val()+'&pedate='+$('input[name=pedate]').val();
        });
