...
<div id="areascontent">
    ...
    <div class="rows">
        ...
        <script type="text/html" lay-filter="menu" id="toolbar-menu">
            ...
            <span class="btn btn-success btn-xs refresh" lay-event="refresh" data-id="<{$u.user_id}>"><span class="glyphicon glyphicon-repeat" aria-hidden="true"></span> 刷新授权</span>
            {{# }else{ }}
        ...
        <script type="text/html" lay-filter="view" id="toolbar-view">
            <button class="btn btn-primary btn-xs" lay-event="view_all">查看</button>
        </script>
        <script type="text/html" id="view-message">
