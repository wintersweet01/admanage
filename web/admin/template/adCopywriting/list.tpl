    ...
    <div class="rows" style="margin-bottom: 0.8%; overflow: hidden;">
        <form method="get" action="" class="form-inline">
            ...
            <div class="form-group form-group-sm">
                ...
                <{if SrvAuth::checkPublicAuth('add',false)}><button type="button" class="btn btn-primary btn-sm" onclick="location.href='?ct=optimizat&ac=addCopywriting'"><i class="glyphicon glyphicon-plus" aria-hidden="true"></i> 添加文案</button><{/if}>
            </div>
        </form>
    </div>
    <div class="rows" style="margin-bottom: 0.8%; overflow: hidden;">
