    ...
    <div class="rows" style="margin-bottom: 0.8%; overflow: hidden;">
        <form method="get" action="" class="form-inline">
            ...
            <div class="form-group">
                ...
                <label>日期</label>
                <input type="text" name="date" readonly value="<{$data.date}>" class="Wdate"/>
            ...
            <div id="tableDiv" style="background-color: #fff;">
                <table class="table table-bordered table-hover table-condensed table-striped table-responsive">
                    ...
                    <tr>
                        ...
                        <td nowrap class="text-danger"><b><{$data.total.old_pay}></b></td>
                        <td nowrap class="text-danger"><b>¥<{$data.total.old_money}></b></td>
                        <td nowrap class="text-danger"><b><{$data.total.interval_pay}></b></td>
                        <td nowrap class="text-danger"><b>¥<{$data.total.interval_money}></b></td>
                        <td nowrap class="text-olive"><b><{$data.total.interval_pay_rate}>%</b></td>
                        <td nowrap class="text-danger"><b>¥<{$data.total.total_money}></b></td>
                        <td nowrap>-</td>
                    </tr>
                    <{foreach from=$data.list item=u}>
                        <tr>
                            <td nowrap><b><{$u.date}></b></td>
                            ...
                            <td nowrap class="text-danger"><b><{$u.old_pay}></b></td>
                            <td nowrap class="text-danger"><b>¥<{$u.old_money}></b></td>
                            <td nowrap class="text-danger"><b><{$u.interval_pay}></b></td>
                            <td nowrap class="text-danger"><b>¥<{$u.interval_money}></b></td>
                            <td nowrap class="text-olive"><b><{$u.interval_pay_rate}>%</b></td>
