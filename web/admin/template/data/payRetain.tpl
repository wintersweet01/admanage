...
<div id="areascontent">
    <div class="rows" style="margin-bottom: 10px; overflow: hidden;">
        <form method="get" action="" class="form-inline">
            ...
            <input type="hidden" name="ac" value="payRetain"/>
            ...
            <div class="form-group">
                ...
                <input type="checkbox" name="has_cost" value="1" <{if $data.has_cost==1}>checked="checked"<{/if}>
                />只显示有消耗的数据
            ...
            <div id="tableDiv" style="background-color: #fff;">
                <table class="table table-bordered table-hover table-condensed table-striped table-responsive">
                    ...
                    <tr>
                        ...
                        <th nowrap>消耗金额</th>
                        <th nowrap>注册数</th>
                        <th nowrap>注册成本<i class="fa fa-question-circle" alt="（消耗金额/注册数）"></i></th>
                        <th nowrap>至昨天天数<i class="fa fa-question-circle" alt="注册日期至昨天的天数"></i></th>
                        <{if $_type == 'pay'}>
                        <th nowrap>累计充值<i class="fa fa-question-circle" alt="注册日期至昨天的累计充值金额"></i></th>
                        <{elseif $_type == 'roi'}>
                        <th nowrap>累计ROI<i class="fa fa-question-circle" alt="注册日期至昨天的累计充值金额/注册日期消耗"></i></th>
                        <{elseif $_type == 'ltv'}>
                        <th nowrap>累计LTV<i class="fa fa-question-circle" alt="注册日期至昨天的累计充值金额/注册日期注册数"></i></th>
                        <{/if}>
                        <{foreach $_day as $d}>
                        <th nowrap><{$d}>日</th>
                        <{/foreach}>
