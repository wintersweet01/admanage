            ...
            <form method="post" action="" class="form-horizontal">
                <!--<div class="form-group">
                    ...
                    <div class="col-sm-5">
                        ...
                        <div class="input-group">
                            <label for="channel_id">渠&nbsp;道：</label>
...
<script>
    $(function () {
        ...
        $('#download').on('click', function () {
            ...
            layer.confirm('确认下载？', function () {
                var url = '?ct=extend&ac=splitManageExcel&parent_id=' + parent_id + '&game_id=' + game_id + '&channel_id=' + channel_id + '&create_user=' + create_user + '';
                layer.closeAll();
                window.open(url);
            });
        });
        ...
        $('#submit').on('click', function () {
            ...
            $.post('?ct=extend&ac=splitUploadAction', {file:$('#upload_file').val()}, function (re) {
                layer.close(index);
                layer.open({
                    type: 1,
                    title: false,
                    ...
                    time: 3000,
                        ...
                        if (re.state == true) {
                            location.href = '?ct=extend&ac=splitManage';
                        }
                    }
                });
            }, 'json');
