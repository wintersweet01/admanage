    ...
    <div class="rows" style="margin-bottom: 0.8%; overflow: hidden;">
        ...
        <form method="get" action="" class="form-inline">
            ...
            <div class="form-group form-group-sm">
                ...
                <label>付款时间</label>
                <input type="text" name="psdate" value="<{$data.psdate}>" class="form-control Wdate" style="width: 100px;"/> -
                <input type="text" name="pedate" value="<{$data.pedate}>" class="form-control Wdate" style="width: 100px;"/>
                    ...
                    <{foreach from=$data.list key=key item=item}>
                        <tr>
                            ...
                            <td nowrap class="text-olive">
                                <b><{if $item.reg}><{($item.retain3*100/$item.reg)|string_format:"%0.2f"}><{else}>0<{/if}>%</b>
                            </td>
                            <td nowrap class="text-olive">
                                <b><{if $item.reg}><{($item.retain7*100/$item.reg)|string_format:"%0.2f"}><{else}>0<{/if}>%</b>
                            </td>
                            <td nowrap class="text-olive">
                                <b><{if $item.reg}><{($item.retain15*100/$item.reg)|string_format:"%0.2f"}><{else}>0<{/if}>%</b>
                            </td>
                            <td nowrap class="text-olive">
                                <b><{if $item.reg}><{($item.retain30*100/$item.reg)|string_format:"%0.2f"}><{else}>0<{/if}>%</b>
                            </td>
                            <td nowrap class="text-olive">
                            ...
                            <td nowrap class="text-olive">
                                <b><{if $item.reg}><{($item.money7/100/$item.reg)|string_format:"%0.2f"}><{else}>0<{/if}></b>
                            </td>

                            <td nowrap class="text-olive">
                                <b><{if $item.reg}><{($item.money30/100/$item.reg)|string_format:"%0.2f"}><{else}>0<{/if}></b>
                            </td>
                            <td nowrap class="text-olive">
                                <b><{if $item.reg}><{($item.money45/100/$item.reg)|string_format:"%0.2f"}><{else}>0<{/if}></b>
                            </td>
                            <td nowrap class="text-olive">
                                <b><{if $item.reg}><{($item.money60/100/$item.reg)|string_format:"%0.2f"}><{else}>0<{/if}></b>
                            </td>
