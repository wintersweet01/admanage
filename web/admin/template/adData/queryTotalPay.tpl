...
<script>
    layui.config({
        ...
        var cols = [[
            ...
            {field:'total_pay_money', width:100, title: '充值金额', align: 'center'},
            {field:'total_pay_num', width:100, title: '充值次数', align: 'center'},
        ...
        var options = {
            ...
            url: '/?ct=adData&ac=queryTotalPay&json=1&data=<{$query}>',
            cellMinWidth: 80,
            height: 'full-100',
            page: true,
            limit: 18,
