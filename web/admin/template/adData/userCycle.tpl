...
<script>
    $(function(){
        $('#printExcel').click(function(){
            location.href='?ct=adData&ac=userCycleExcel&game_id='+$('select[name=game_id]').val()+'&user_id='+$('select[name=user_id]').val()+'&sdate='+$('input[name=sdate]').val()+'&edate='+$('input[name=edate]').val();
        });
    });
</script>
