...
<script>
    $(function(){
        ...
        $('#printExcel').click(function(){
            ...
            location.href='?ct=adData&ac=hourLandExcel&game_id='+$('select[name=game_id]').val()+channel_ids+'&package_name='+$('select[name=package_name]').val()+'&sdate='+$('input[name=sdate]').val()+'&edate='+$('input[name=edate]').val();
        });
