...
<script>
    $(function(){
        ...
        $('#printExcel').click(function(){
            ...
            location.href='?ct=adDataAndorid&ac=channelEffectExcel&game_id='+$('select[name=game_id]').val()+channel_ids+'rsdate='+$('input[name=rsdate]').val()+'&redate='+$('input[name=redate]').val()+'&psdate='+$('input[name=psdate]').val()+'&pedate='+$('input[name=pedate]').val();
        });
