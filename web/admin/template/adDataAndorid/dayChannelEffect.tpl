    ...
    <div class="rows" style="margin-bottom: 0.8%; overflow: hidden;">
        ...
        <form method="get" action="" class="form-inline">
            ...
            <div class="form-group">
                ...
                <lable>注册时间</lable>
                <input type="text" name="sdate" value="<{$data.sdate}>" class="Wdate" style="width: 100px;" /> -
                <input type="text" name="edate" value="<{$data.edate}>" class="Wdate" style="width: 100px;" />
                <lable>付款时间</lable>
                <input type="text" name="psdate" value="<{$data.psdate}>" class="Wdate" style="width: 100px;" /> -
                <input type="text" name="pedate" value="<{$data.pedate}>" class="Wdate" style="width: 100px;" />
