...
<head>
    ...
    <link rel="stylesheet" href="<{$smarty.const.SYS_STATIC_URL}>zTree_v3/css/zTreeStyle/zTreeStyle.css" type="text/css">
    <style>
    ...
    <div class="layui-row">
        <div class="layui-col-md12 content">
            <form  action="" class="layui-form">
                <input type="hidden" id="static-url" value="<{$smarty.const.SYS_STATIC_URL}>">
...
<script src="<{$smarty.const.SYS_STATIC_URL}>zTree_v3/js/jquery.ztree.core.js"></script>
<script src="<{$smarty.const.SYS_STATIC_URL}>zTree_v3/js/jquery.ztree.exhide.js"></script>
<script src="<{$smarty.const.SYS_STATIC_URL}>zTree_v3/js/fuzzysearch.js"></script>
<script src="<{$smarty.const.SYS_STATIC_URL}>/js/jrtt-form.js?v=1"></script>
<script src="<{$smarty.const.SYS_STATIC_URL}>/js/schedule-time-select.js"></script>
<script src="<{$smarty.const.SYS_STATIC_URL}>zTree_v3/js/jquery.ztree.excheck.js"></script>
</body>
</html>